...
- **A live advisory against the pinned `pip` is cleared** ([#541](https://github.com/oblangatas/worthless/pull/541)). `PYSEC-2026-3721` was published against `pip 26.1.2` on 2026-08-20 and turned the new dependency gate red within hours of it merging — the first thing the gate caught, and exactly the behaviour its own entry predicted. Bumped to 26.2.1, lockfile only.
