...
<CardGrid>
  <Card title="Solo dev" icon="laptop">
    `pipx install worthless`. One command, no config.
  ...
  <Card title="Claude Code, Cursor, Windsurf" icon="seti:code-search">
    MCP server for AI editors. Manually verified on Claude Code & Cursor (macOS, 2026-07-09, not yet CI-covered); Windsurf **unverified**.
