...
- To report a vulnerability, see [SECURITY.md](https://github.com/oblangatas/worthless/blob/main/SECURITY.md).
- Contributor invariants (the SR-\* rules) live in [CONTRIBUTING-security.md](https://github.com/oblangatas/worthless/blob/main/CONTRIBUTING-security.md).
...
**Code.** [`src/worthless/crypto/splitter.py`](https://github.com/oblangatas/worthless/blob/main/src/worthless/crypto/splitter.py)
...
**Tests.** [`tests/test_invariants.py`](https://github.com/oblangatas/worthless/blob/main/tests/test_invariants.py):
...
**Code.** [`src/worthless/proxy/app.py`](https://github.com/oblangatas/worthless/blob/main/src/worthless/proxy/app.py) —
...
**Tests.** [`tests/test_security_properties.py::TestGateBeforeDecrypt`](https://github.com/oblangatas/worthless/blob/main/tests/test_security_properties.py):
...
**Code.** [`src/worthless/crypto/splitter.py::secure_key`](https://github.com/oblangatas/worthless/blob/main/src/worthless/crypto/splitter.py)
...
5. `rename(2)` tmp → final (atomic on POSIX filesystems that
   `fs_check` has admitted — see [`UnsafeReason.FILESYSTEM`](https://github.com/oblangatas/worthless/blob/main/src/worthless/cli/fs_check.py)).
