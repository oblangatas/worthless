...
```bash
git clone https://github.com/oblangatas/worthless && cd worthless/deploy
...
Template configs are in [`deploy/`](https://github.com/oblangatas/worthless/tree/main/deploy)
...
The proxy runs on `localhost:8787`. See the [README](https://github.com/oblangatas/worthless#readme) for the full command reference.
