...
echo
echo "  Recovery (a re-run will NOT help — it replays the same tree):"
echo "    1. Check arm64 without waiting for Monday:"
echo "       gh workflow run docker-security.yml --ref main"
