...
| In progress | `WOR-597` | Second-pass adversarial install failure journeys: stale PATH, partial install, PATH breakage, uninstall truth |
...
- Install proof is better than unit tests but not identical to the public user
  ...
  starting with stale binaries that shadow the fresh uv-installed tool.
